...
if (isset($_POST['view'])) {
  ...
  $con=mysqli_connect($host,$db_user,$db_password,$db_name,$port);
  echo "Campaign id,Question Number,Question,Answer1,Answer2,Answer3";
  
  if ($result = mysqli_query($con, "select * from mcq")) {
  while ($obj = mysqli_fetch_object($result)) {
  echo ' <br>'.$obj->CAMPAIGN_ID. ','.$obj->QNo. ','.$obj->QUESTION.'<br>'. $obj->ANSWER1.'<br>'.$obj->ANSWER2.'<br>'. $obj->ANSWER3;
  }
  ...
  function add()
  {
  	echo '<h6 class="w3-medium w3-animate-top"><form method="post" action="admins.php">
